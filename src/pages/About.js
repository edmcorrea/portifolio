    ...
    return (
      <div className='about'>
        ...
        <section className='intro-about'>
          ...
          <p>Como professor, desde os 12 anos de idade, estudava e trabalhava no curso Kumon e considero esse curso como o carro chefe da minha formação pessoal e profissional, pois habilidades como disciplina, hábito de estudo, gerenciamento de tempo, autodidatismo e a curiosidade pelos porquês vieram desse período.</p>
          ...
          <p>Minha paixão por tecnologia veio durante um projeto de uma startup que idealizei mais um colega (engenheiro da computação), voltado para a área de construção civil, que consiste em uma impressora 3D que imprime casas residenciais. A fim de agilizar o projeto, comecei meus estudos na área de desenvolvimento e reconheci meu interesse. Assim, para começar meu estudos em programação, abdiquei da empresa de reformas residenciais e me mantive apenas com a renda das vendas e atividades home-office de engenheiro civil.</p>
          <p>Por fim, falando sobre ambições, desejo seguir a área de desenvolvimento, fazer faculdade na área de engenharia da programação para me destacar na área, pois é evidente que há muitos leques no mercado para essa área.</p>
        </section>
